...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.btnAsync_task);
        ...
        btnLeakCanary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "Rotate the phone now and wait, you have 10secs to test this", Toast.LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (result != null) {
            if (result.getContents() == null) {
                ...
                Toast.makeText(this, "The scan has been Cancelled ", Toast.LENGTH_SHORT).show();
            }else{
                Log.d(TAG, "onActivityResult: Scanned");
                Toast.makeText(this, "Succesful Scan " + result.getContents().toString(), Toast.LENGTH_LONG).show();
            }
        }else{
    ...
    public void onDestroy() {
        super.onDestroy();
        RefWatcher ref = MyApplicationDemo.getRefWatcher(this);
        ref.watch(this);
    }
}
